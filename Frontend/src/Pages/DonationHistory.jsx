...
const DonationHistory = () => {
    ...
    if (isError) {
        return <div className="min-h-screen p-6 bg-zinc-950 text-red-500 flex items-center justify-center">Failed to load donation history.</div>;
    }
                ...
                <div className="grid gap-6">
                    {donations && donations.length > 0 ? (
                        ...
                        <div className="text-center py-12 bg-zinc-950/30 rounded-xl border border-zinc-800/50 border-dashed">
                            ...
                            <p className="text-zinc-500 font-medium">No donation history found</p>
                            {user?.role === 'Donor' && (
                                <div className="mt-6">
